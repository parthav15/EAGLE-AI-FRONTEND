    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center">
                ...
                >
                    <div className="w-full max-w-2xl bg-gray-800/10 backdrop-blur-lg p-10 rounded-xl shadow-lg border border-white/20">
                        <motion.h1
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="w-full bg-cyan-500 hover:bg-cyan-600 text-white py-2 px-4 rounded-lg font-bold text-lg transition-all"
                            >
                                Create Post
                            </motion.button>
                        </motion.form>
