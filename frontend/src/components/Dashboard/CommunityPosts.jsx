      ...
      <AnimatePresence>
        {editingPost ? (
          <motion.div
            ...
            className="bg-slate-700/20 p-6 rounded-lg border border-slate-600 shadow-lg"
          >
            <h3 className="text-lg font-bold text-slate-100 mb-4">Edit Post</h3>
            <form onSubmit={handleUpdatePost} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 rounded border border-slate-500 bg-slate-800 text-slate-100"
                  required
                />
              </div>
              <div>
          ...
          >
            {posts.length === 0 && (
              ...
              >
                ...
                <Link to="/community/new-post">
                  <motion.button
                    className="bg-cyan-500 text-white px-4 py-2 rounded hover:bg-cyan-600 shadow-lg"
            ...
            {posts.map(post => (
              <div key={post.id} className="bg-slate-700/20 p-4 rounded-lg border border-slate-600">
